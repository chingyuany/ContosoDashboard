...
namespace ContosoDashboard.ContosoDashboard.Data.Migrations
{
    /// <inheritdoc />
    public partial class AddDocumentEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentActivities", x => x.ActivityId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaskId = table.Column<int>(type: "INTEGER", nullable: false),
                    DocumentId = table.Column<int>(type: "INTEGER", nullable: false),
                    AssociatedDate = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2026, 5, 14, 19, 48, 55, 140, DateTimeKind.Utc).AddTicks(7090), "IT", "System Administrator", "admin@contoso.com", true, true, "Administrator", null, null, null, 3 },
                    { 2, 0, new DateTime(2026, 5, 14, 19, 48, 55, 140, DateTimeKind.Utc).AddTicks(7320), "Engineering", "Camille Nicole", "camille.nicole@contoso.com", true, true, "Project Manager", null, null, null, 2 },
                    { 3, 0, new DateTime(2026, 5, 14, 19, 48, 55, 140, DateTimeKind.Utc).AddTicks(7320), "Engineering", "Floris Kregel", "floris.kregel@contoso.com", true, true, "Team Lead", null, null, null, 1 },
                    { 4, 0, new DateTime(2026, 5, 14, 19, 48, 55, 140, DateTimeKind.Utc).AddTicks(7320), "Engineering", "Ni Kang", "ni.kang@contoso.com", true, true, "Software Engineer", null, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "Announcements",
                columns: new[] { "AnnouncementId", "Content", "CreatedByUserId", "ExpiryDate", "IsActive", "PublishDate", "Title" },
                values: new object[] { 1, "Welcome to the new ContosoDashboard application. This platform will help you manage your tasks and projects more efficiently.", 1, new DateTime(2026, 6, 13, 19, 48, 55, 142, DateTimeKind.Utc).AddTicks(2770), true, new DateTime(2026, 5, 14, 19, 48, 55, 142, DateTimeKind.Utc).AddTicks(2700), "Welcome to ContosoDashboard" });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "CreatedDate", "Description", "Name", "ProjectManagerId", "StartDate", "Status", "TargetCompletionDate", "UpdatedDate" },
                values: new object[] { 1, new DateTime(2026, 4, 14, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(50), "Internal employee productivity dashboard", "ContosoDashboard Development", 2, new DateTime(2026, 4, 14, 19, 48, 55, 140, DateTimeKind.Utc).AddTicks(9730), 1, new DateTime(2026, 7, 13, 19, 48, 55, 140, DateTimeKind.Utc).AddTicks(9870), new DateTime(2026, 5, 14, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(150) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 14, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1870), 1, "TeamLead", 3 },
                    { 2, new DateTime(2026, 4, 14, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1940), 1, "Developer", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 2, new DateTime(2026, 4, 14, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1250), "Create entity relationship diagram and database design", new DateTime(2026, 4, 24, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(970), 2, 1, 2, "Design database schema", new DateTime(2026, 4, 24, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1320) },
                    { 2, 4, 2, new DateTime(2026, 4, 19, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1390), "Set up Microsoft Entra ID authentication", new DateTime(2026, 5, 19, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1390), 3, 1, 1, "Implement authentication", new DateTime(2026, 5, 14, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1390) },
                    { 3, 4, 2, new DateTime(2026, 4, 24, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1390), "Design user interface mockups for all main pages", new DateTime(2026, 5, 24, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1390), 1, 1, 0, "Create UI mockups", new DateTime(2026, 4, 24, 19, 48, 55, 141, DateTimeKind.Utc).AddTicks(1390) }
                });
